...
public class BorrarAdopcion extends HttpServlet{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if( req.getParameter("nombre")!=null){
			...
			final Query q = pm.newQuery(Adopcion.class);
			q.setFilter("nombre == nombreParam");
			q.declareParameters("int nombreParam");	
				
			try{
				q.deletePersistentAll(nombre);
				(getServletContext().getRequestDispatcher("/WEB-INF/jspAdmin/listaAdopcion.jsp")).forward(req,resp);
