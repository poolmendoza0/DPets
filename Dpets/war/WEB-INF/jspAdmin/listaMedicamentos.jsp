...
<%@ page import="bing.Medicina"%>
<%@ page import="Servlets.PMF"%>
<%@ page import="java.util.List"%>
<%@ page import="javax.jdo.PersistenceManager "%>
<%
	List<Medicina> personas = (List<Medicina>) request
	...
	<br><br><br>
		<div id="envoltura">
			<div id="contenedor">
				...
				<div id="cuerpo">
					<form action="/medicinaborrar" id="form-login" method="post">

						<p>
							<label>Eliminar:</label>
						</p>
						<input name="nom" type="text" id="nom" size="20"
							placeholder="Nombre del Medicina" value="" autofocus=""
							required="">
						</p>
			...
			<div>
				<center>
					...
					<table border="2" bgcolor="white">
						...
						<%
							try {
								List<Medicina> medicina = (List<Medicina>) q.execute("");
		...
		<div class="top">
			...
			<footer id="izq">
				<a href="" class="toplink" rel="nofollow"><img
					src="http://www.davidhechtkitchens.com/images/button-back-to-top.png"><i
					class=" icon-chevron-sign-up"></i></a>
			</footer>
	</footer>
