...
<%@ page import="bing.Producto"%>
<%@ page import="Servlets.PMF"%>
<%@ page import="java.util.List"%>
<%@ page import ="javax.jdo.PersistenceManager "%>
<% List<Producto> personas = (List<Producto>)request.getAttribute("personas");%>
...
<% PersistenceManager pm = PMF.get().getPersistenceManager();%>
		...
		<div id="contenedor">
			...
			<div id="cabecera">
				<b>Eliminar producto</b><br> <img
					src="http://www.cookieswil.com/media/files/uploads/2014/02/Seguros-para-perros-y-gatos.3-300x225.jpg"
					width="75" height="80">
			</div>

			<div id="cuerpo">
				<form action="/productoborrar" id="form-login" method="post">
					
					<p>
						<label>Eliminar:</label>
					</p>
					<input name="nomb" type="text" id="nomb" size = "20" placeholder="Nombre del Producto" value= ""
						autofocus="" required="">
					</p>
