...
<%@ page import="bing.Sugerencia"%>
<%@ page import="Servlets.PMF"%>
<%@ page import="java.util.List"%>
<%@ page import ="javax.jdo.PersistenceManager "%>
<% List<Sugerencia> personas = (List<Sugerencia>)request.getAttribute("personas");%>			
...
<% PersistenceManager pm = PMF.get().getPersistenceManager();%>
		<%Query q = pm.newQuery(Sugerencia.class);
				...
				<table border = "2">
				<tr>
				  <th><strong><center><font size=4 color='white'>___</font>Nº<font size=4 color='white'>___</font><center></strong></th>
				  <th><strong><center>Nombre</center></strong></th>
				  <th><strong><center>Sugerencia</center></strong></th>
				</tr>
	
		
		<%try{
			List<Sugerencia> sugerencia = (List<Sugerencia>) q.execute("");
			for(Sugerencia p: sugerencia){
			%>
				<tr>
				<% 
				out.println(p);
