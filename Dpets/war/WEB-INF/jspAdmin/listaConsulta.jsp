...
<%@ page import="bing.Consulta"%>
<%@ page import="Servlets.PMF"%>
<%@ page import="java.util.List"%>
<%@ page import ="javax.jdo.PersistenceManager "%>
<% List<Consulta> personas = (List<Consulta>)request.getAttribute("personas");%>
...
<% PersistenceManager pm = PMF.get().getPersistenceManager();%>
		<%Query q = pm.newQuery(Consulta.class);
				...
				<tr>
				  ...
				  <th><strong><center>Apellido</center></strong></th>
				  <th><strong><center>Correo</center></strong></th>
				  <th><strog><center>Consulta</center></strong></th>
				</tr>
	
		
		<%try{
			List<Consulta> consulta = (List<Consulta>) q.execute("");
			for(Consulta p: consulta){
			%>
				<tr>
				<% 
				out.println(p);
