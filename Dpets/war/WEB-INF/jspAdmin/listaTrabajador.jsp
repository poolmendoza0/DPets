...
<%@ page import="bing.Trabajador"%>
<%@ page import="Servlets.PMF"%>
<%@ page import="java.util.List"%>
<%@ page import ="javax.jdo.PersistenceManager "%>
<% List<Trabajador> personas = (List<Trabajador>)request.getAttribute("personas");%>
...
<% PersistenceManager pm = PMF.get().getPersistenceManager();%>
		...
		<%try{
			List<Trabajador> mascota = (List<Trabajador>) q.execute("");
			for(Trabajador p: mascota){
			%>
				<tr>
				<% 
				out.println(p);
		...
		<div id="contenedor">
			...
			<div id="cabecera">
				<b>Eliminar trabajador</b><br> <img
					src="http://www.cookieswil.com/media/files/uploads/2014/02/Seguros-para-perros-y-gatos.3-300x225.jpg"
					width="75" height="80">
			</div>

			<div id="cuerpo">
				<form action="/borrarTrabajador" id="form-login" method="post">
					
					<p>
						<label>Eliminar:</label>
					</p>
					<input name="nombre" type="text" placeholder="Nombre del Especialista" value= "">
					</p>
