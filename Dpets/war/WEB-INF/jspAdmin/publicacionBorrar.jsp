...
<%
	List<Publicacion> personas = (List<Publicacion>) request
		...
		%>
			...
			<div>
							...
							<table border="2">
								...
								<%
									try {
										List<Publicacion> publicacion = (List<Publicacion>) q
												.execute("");
			...
			<div id="envoltura">
				<div id="contenedor">
					...
					<div id="cabecera">
						<b>Borrar Publicacion</b><br> <img
							src="http://www.cookieswil.com/media/files/uploads/2014/02/Seguros-para-perros-y-gatos.3-300x225.jpg"
							width="75" height="80">
					</div>

					<div id="cuerpo">
						<form action="/publicacionborrar" id="form-login" method="get"
							autocomplete="off">

							<p>
								<label>Eliminar:</label>
							</p>
							<input name="nume" type="number" id="nume" size="20"
								placeholder="Numero comentario" value="" autofocus=""
								required="">
								</p>
