...
<%@ page import="bing.Adopcion"%>
<%@ page import="Servlets.PMF"%>
<%@ page import="java.util.List"%>
<%@ page import ="javax.jdo.PersistenceManager "%>
<% List<Adopcion> personas = (List<Adopcion>)request.getAttribute("personas");%>
...
<% PersistenceManager pm = PMF.get().getPersistenceManager();%>
		<%Query q = pm.newQuery(Adopcion.class);
				%>
				...
				<tr>
				  <th><strong><center>Nombre, Apellido<center></strong></th>
				  <th><strong><center>Especie</center></strong></th>
				  <th><strong><center>Edad</center></strong></th>
				  <th><strong><center>Sexo</center></strong></th>
				  <th><strong><center>Descripcion</center></strong></th>
				  <th><strong><center>Mensaje</center></strong></th>
		...
		<%try{
			List<Adopcion> adopcion = (List<Adopcion>) q.execute("");
			for(Adopcion p: adopcion){
			%>
				<tr>
				<% 
				out.println(p);
		...
		<div id="contenedor">
			...
			<div id="cabecera">
				<b>Borrar adoptante</b><br> <img
					src="http://www.cookieswil.com/media/files/uploads/2014/02/Seguros-para-perros-y-gatos.3-300x225.jpg"
					width="75" height="80">
			</div>

			<div id="cuerpo">
				<form action="/borrarAdopcion" id="form-login" method="post">
					
					<p>
						<label>Eliminar:</label>
					</p>
					<input name="nombre" type="text" id="nombre" size = "20" placeholder="Nombre" value= ""
						autofocus="" required="">
					</p>
