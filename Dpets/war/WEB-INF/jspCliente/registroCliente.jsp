			...
			<div id="cuerpo">
				<form action="/crearPersona" id="form-login" method="post"
					...
					<input name="dni" type="number" id="dni"
						placeholder="DNI"  min = "10000000" max = "99999999" autofocus="" required="">
					</p>
					...
					<input name="pet" type="text" id="pet" placeholder="Nombre mascota"
						autofocus="" required="">
					</p>
