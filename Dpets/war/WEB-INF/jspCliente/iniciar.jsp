...
<body>
	...
	<nav> Perros<br> Gatos<br> Conejos<br> Roedores<br>
					M.exoticas<br> <img
	...
	<div id="envoltura">
		<div id="contenedor">
			...
			<div id="cabecera">
				<b>Iniciar sesion</b><br> <img
					src="http://www.revistacarrusel.cl/wp-content/uploads/2012/05/mascota-y-nino.jpg"
					width="75" height="80">
			</div>

			<div id="cuerpo">
				<form action="/entrarcomprobar" id="form-login" method="post"
					autocomplete="off">
					...
					<input name="username" type="text" id="username"
						...
						placeholder="Password" required="">
							...
							<p id="bot">
								<input type="submit" id="submit" name="submit" value="Iniciar" class="boton">
							</p>
				</form>
			</div>
			<!--fin cuerpo-->

			<div id="pie">Inicio Sesion</div>
		</div>
		<br><br><br>
